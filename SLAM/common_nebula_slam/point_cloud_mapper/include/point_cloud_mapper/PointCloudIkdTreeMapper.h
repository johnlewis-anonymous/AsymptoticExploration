...
private:
  ...
  std::string fixed_frame_id_,world_frame_id_,lidar_frame_id_;
  ...
  bool acquired_transform_;

  // Map parameters.
  double octree_resolution_;
  tf::TransformListener listener;
  tf::TransformListener world_map_listener;
  tf::StampedTransform transform_world_map;
  tf::StampedTransform transform, transform_world_fixed;
  ...
  ros::Publisher m_markerFrontierPub;
